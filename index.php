...
<html lang="ja">
    ...
    <body>
        <div class="jumbotron jumbotron-fluid p-0 m-0 top-page">
            <div class="container d-flex align-items-center">
                <div class="box">
                    <p class="calligrapher">CALLIGRAPHER</p>
                    <img class="d-block m-0 logo-shinjapan" src="<?php echo get_template_directory_uri(); ?>/images/logo_shinjapan.png" alt="">
                    <img class="d-block logo-shomayumi" src="<?php echo get_template_directory_uri(); ?>/images/logo_shomayumi.png" alt="">
                </div>
            </div>
        </div>
        
        <div class="jumbotron jumbotron-fluid p-0 m-0 shinjapan">
            <div class="container d-flex align-items-center">
        ...
        <div class="jumbotron jumbotron-fluid p-0 m-0 work">
            <div class="container">
        ...
        <div class="jumbotron jumbotron-fluid p-0 m-0 work-introduction">
            <div class="container">
                <div class="box text-center">
                    <h1 class="section-title">WORK INTRODUCTION</h1>
                    <p>comming soon ...</p>
                    <!-- <p>MORE</p> -->
                </div>
            </div>
        ...
        <div class="jumbotron jumbotron-fluid p-0 m-0 news">
            <div class="container">
                <div class="box text-center">
        ...
        <div class="jumbotron jumbotron-fluid p-0 m-0 profire">
            <div class="container">
                <div class="box">
                    <h1 class="section-title text-center">PROFIRE</h1>
                    <img class="profire-img float-left" src="<?php echo get_template_directory_uri(); ?>/images/profile_img.png" alt="">
                    <p class="calligrapher">CALLIGRAPHER</p>
                    <H1 class="profire-name">真弓  将</H1>
                    <p>SHO MAYUMI</p>
                    <p class="profire-text">12歳より書を学び、野球部に在籍する傍ら、ほぼ独学で書に励んでいる。<br>高校時代は石川・星稜高校野球部に在籍し、1年夏、3年夏に全国高校野球選手権に出場。そして高校卒業時には、当時の監督の意向で同行の室内練習場に格言『耐えて勝つ』『心温かきは万能なり』など、約20枚の作品を寄贈した。さらに2019年春のセンバツに北信越地区代表として同校が出場した際には、チームのモットー『一味同心』を朝日新聞社に揮毫し、センバツ特集“書道アーティストを目指すOB”として紹介された。<br>現在は京都先端科学大学・硬式野球部に在籍しており、野球で得た感性を書道にも活かせないかと、日々試行錯誤を繰り返す。<br>将来は世界中の人に日本の書を発信し、『COOL JAPAN』を広める活動を目標に掲げている。</p>
                </div>
            </div>
        </div>

        <div class="jumbotron jumbotron-fluid p-0 m-0 contact">
            <div class="container">
                <div class="box">
                    ...
                    <form action="confirm.php" method="post" name="Form1">
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control rounded-0" placeholder="" name="name" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control rounded-0" placeholder="" name="address">
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control rounded-0" placeholder="" name="phone">
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-center">
                            ...
                            <div class="col-5">
                                <input type="email" class="form-control rounded-0" placeholder="xxxxxx@example.com" name="email" required>
                            </div>
